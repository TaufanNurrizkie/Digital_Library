...
<section  class="px-8 mt-12 text-center">
  ...
  <div class="flex flex-col md:flex-row items-center mt-6 gap-8">
    ...
    data-aos-easing="ease-in-sine" class="w-full md:w-1/2 flex justify-center">
    ...
    data-aos-offset="300"
     data-aos-duration="1500"
    data-aos-easing="ease-in-sine" class="w-full md:w-1/2 text-left">
  ...
  <!-- Featured Books -->
  <section class="px-8 mt-12 text-center">
    <h2 class="text-3xl font-bold text-blue-900">Koleksi Unggulan</h2>
    <div class="grid grid-cols-2 md:grid-cols-4 gap-6 mt-6">
      <div class="bg-gray-300 p-6 rounded-lg shadow-md">Buku 1</div>
      <div class="bg-gray-300 p-6 rounded-lg shadow-md">Buku 2</div>
      <div class="bg-gray-300 p-6 rounded-lg shadow-md">Buku 3</div>
      <div class="bg-gray-300 p-6 rounded-lg shadow-md">Buku 4</div>
    </div>
  </section>

  <!-- Call to Action -->
  <section class=" text-black py-16 text-center mt-12">
